...
public class _01_unaryOperators {
	...
	public static void main(String[] args) {
		...
		System.out.println("int postInc = 10;\nPrint it to terminal and incremented in memory result is : " + postInc++);
		System.out.println("After incremented postInc variable value came from memory and result is  : " + postInc + "\n");
		
		// Post Decrement
		System.out.println("POST-DECREMENT");
		System.out.println("int postDec = 5;\nPrint it to terminal and decrementd in memory result is : " + postDec--);
		System.out.println("After decremented postDec variable value came from memory and result is  : " + postDec + "\n");
		
		
		// Pre-increment
		System.out.println("PRE-INCREMENT");
		System.out.println("int preInc = 10;\nFirstly increment it in memory and Print it to terminal result is : " + ++preInc + "\n");
		
		// Pre-Decrement
		System.out.println("PRE-DECREMENT");
		System.out.println("int pretDec = 5;\nFirstly decrement it in memory and Print it to terminal result is : " + --preDec + "\n");
