...
public class Microsoft {
	...
	public static void main(String[] args) {
		...
		// Employee emp1 = new Employee(); since we don't have a default a constructor
		// anymore it gives error
...
//		Employee emp2 = new Employee("Vasilica","ScrumMaster",5,120.000);
		...
		Employee[] testers = { new Employee("Eyup", "SDET", 10, 100_000),
				new Employee("Vasilica", "ScrumMaster", 5, 120_000), new Employee("Selena", "QA Engineer", 7, 85_000),
