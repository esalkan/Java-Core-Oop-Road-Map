 ...
 */
public class _01_ArraysFundementals {
	...
	public static void main(String[] args) {
		...
		// This way is good to use when we know the count of items, but we do not know
		// the values yet.
		...
		// Declare and assign value in the same statement. This is good when we already
		// have data to assign to
