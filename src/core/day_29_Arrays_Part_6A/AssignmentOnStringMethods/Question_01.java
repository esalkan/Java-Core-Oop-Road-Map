package core.day_29_Arrays_Part_6A.AssignmentOnStringMethods;
...
public class Question_01 {
	...
	public static void main(String[] args) {
		...
		tipCalculator(splitCheck, numberOfPeople, checkAmount, serviceQuality);

	}

	public static void tipCalculator(String splitCheck, int numberPeople, double checkAmount, String serviceQuality) {
