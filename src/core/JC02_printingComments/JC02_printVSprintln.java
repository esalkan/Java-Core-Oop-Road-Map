...
public class JC02_printVSprintln {
	...
	public static void main(String[] args) {
		...
		// println() içerisine bir veri göndermez isek, bir alt satıra geç mantığından <br> html'de olduğu gibi bir satır boşluk oluşturur bir nevi ENTER tuşu işlemi görür.
		System.out.println();
