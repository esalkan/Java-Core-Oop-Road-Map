 ...
 */
public class JC08_stringConcat {
	...
	public static void main(String[] args) {
		 ...
		 * concat()
		 * 
		 * --> concat() method combines specified string at the end of this string. It
		 ...
		 * 
		 * 
		 * concat(String) : Combines specified string at the end of this strring. it
