...
public class _00_Summary {
	...
	// - Instance Variables: 
	// *-> Non-static variables and are declared in a class
	...
	//
	//
	// Inheritance: - > One class inherits the features(fields and methods) of
	// another class.
	...
	//
	// this() vs super() : - > this() is used to call constructor from another
	...
	// - It is used to make sure the class variables are accessible only to
	// subclasses
	//
