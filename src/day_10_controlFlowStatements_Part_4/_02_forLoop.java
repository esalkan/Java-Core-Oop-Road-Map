...
public class _02_forLoop {
		...
		//	Loops check a condition. If it returns true, a code block will run. Then the condition will
		//	be checked again and if it is still returns true, the code block will run again. It repeats
