...
public class _12_mixedInteger {
	...
	-> When values of the byte or short data types are used in arithmetic 
	expressions, they are temporarily converted to int values.
	
	-> The result of an arithmetic operation using only a mixture of byte, 
